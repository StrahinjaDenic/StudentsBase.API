...
{
    public partial class AddDbContextModelSnapshot : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExaminationDates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    ExaminationDateId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exams_ExaminationDates_ExaminationDateId",
                        column: x => x.ExaminationDateId,
                        principalTable: "ExaminationDates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPorfessorCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentPorfessorCourses_ProfessorCourses_ProfessorCourseId",
                        column: x => x.ProfessorCourseId,
                        principalTable: "ProfessorCourses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentPorfessorCourses_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_ExaminationDateId",
                table: "Exams",
                column: "ExaminationDateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPorfessorCourses_ProfessorCourseId",
                table: "StudentPorfessorCourses",
                column: "ProfessorCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentPorfessorCourses_StudentId",
                table: "StudentPorfessorCourses",
                column: "StudentId");
        }
